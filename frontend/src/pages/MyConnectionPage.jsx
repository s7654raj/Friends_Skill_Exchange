  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="w-64 bg-white border-r border-gray-200 p-4 fixed h-full">
        <h2 className="text-lg font-semibold mb-4 text-gray-700 p-2">
          Connections
        </h2>
      ...
      <div className="ml-64 flex-grow p-8">
        {/* Header and Stats - Always Visible */}
        <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <p className="text-3xl font-bold text-blue-600">
              {connectionRequests.received.length}
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">
            ...
            <p className="text-3xl font-bold text-green-600">
              {connectionRequests.sent.length}
            </p>
          </div>
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-800 mb-2">
                        ...
                        onClick={() =>
                          navigate("/chat", {
                            state: {
                              ...
                              recipientName: student.userId.name,
                            },
                          })
                        }
                        className="flex-1 bg-gradient-to-r from-purple-500 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-purple-600 hover:to-purple-700 transition-all duration-200 font-medium"
                      >
                        Chat Now
                      </button>
                    </div>
